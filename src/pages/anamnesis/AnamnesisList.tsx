...
type FilterStatus =
  'all' | 'draft' | 'in_progress' | 'review' | 'finalized' | 'corrected' | 'archived'
  ...
  const getActionForStatus = (anamnesis: Anamnesis) => {
    ...
    switch (anamnesis.status) {
      ...
      default:
        return {
          label: 'Visualizar',
          path: `/patients/${patientId}/anamneses/${anamnesis.id}/view`,
        }
    }
  }
          ...
          <ul className="divide-y divide-gray-200">
            {filteredAnamneses.map((a) => {
              ...
              return (
                <li
                  key={a.id}
                  className="py-4 flex items-center justify-between hover:bg-gray-50 -mx-6 px-6 transition"
                >
                  <div className="flex flex-col">
                    ...
                    <div className="mt-2 flex items-center gap-2">
                      ...
                      <span className="text-xs text-gray-500">
                        {a.completionPercentage}% concluída
                      </span>
                    </div>
                  </div>
