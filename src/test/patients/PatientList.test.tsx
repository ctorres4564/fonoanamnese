...
describe('PatientList', () => {
  ...
  it('renders loading state initially', () => {
    (patientService.listPatientsByProfessional as any).mockImplementation(() => new Promise(() => {})); // Never resolves
    (patientService.listArchivedPatientsByProfessional as any).mockImplementation(() => new Promise(() => {})); // Never resolves
    renderWithProviders();
  ...
  it('renders list of active patients', async () => {
    const mockPatients = [
      { id: '1', fullName: 'João Silva', recordNumber: '101', status: 'evaluation', isArchived: false },
    ];
    const mockArchived = [
      { id: '2', fullName: 'Maria Souza', recordNumber: '102', status: 'therapy', isArchived: true },
    ];
