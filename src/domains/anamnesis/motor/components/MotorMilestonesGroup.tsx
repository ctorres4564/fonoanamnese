  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="space-y-4">
          <MotorMilestoneField
            namePath="motorDevelopment.milestones.sittingWithSupport"
            label="Sentar com apoio"
          />
          <MotorMilestoneField
            namePath="motorDevelopment.milestones.sittingWithoutSupport"
            label="Sentar sem apoio"
          />
          <MotorMilestoneField
            namePath="motorDevelopment.milestones.standingWithSupport"
            label="Ficar em pé com apoio"
          />
          <MotorMilestoneField
            namePath="motorDevelopment.milestones.standingWithoutSupport"
            label="Ficar em pé sem apoio"
          />
          <MotorMilestoneField namePath="motorDevelopment.milestones.running" label="Correr" />
          <MotorMilestoneField
            namePath="motorDevelopment.milestones.climbingStairs"
            label="Subir escadas"
          />
          <MotorMilestoneField
            namePath="motorDevelopment.milestones.descendingStairs"
            label="Descer escadas"
          />
          <MotorMilestoneField
            namePath="motorDevelopment.milestones.jumpingWithBothFeet"
            label="Pular com os dois pés"
          />
          <MotorMilestoneField namePath="motorDevelopment.milestones.balance" label="Equilíbrio" />
          <MotorMilestoneField
            namePath="motorDevelopment.milestones.globalMotorCoordination"
            label="Coordenação motora global"
          />
        </div>
      </div>
