          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Forma Predominante de Comunicação
              </label>
              <select
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Extensão Média Percebida
              </label>
              <input
                type="number"
                min="0"
                {...register('languageDevelopment.sentenceDevelopment.perceivedAverageLength', {
                  valueAsNumber: true,
                })}
                className="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
              />
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Número Aproximado de Palavras por Frase
              </label>
              <input
                type="number"
                min="0"
                {...register(
                  'languageDevelopment.sentenceDevelopment.approximateWordsPerSentence',
                  { valueAsNumber: true },
                )}
                className="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
              />
            ...
            <div>
              ...
              >
                <option value="">Selecione...</option>
                {SENTENCE_COMPLEXITY_OPTIONS.map((opt) => (
                  <option key={opt} value={opt}>
                    {opt}
                  </option>
                ))}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Presença de Erros Gramaticais Percebidos
              </label>
              <select
