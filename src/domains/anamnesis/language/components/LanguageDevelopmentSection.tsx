...
export function LanguageDevelopmentSection({
  initialData,
  onChange,
}: LanguageDevelopmentSectionProps) {
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm space-y-6">
          <h3 className="text-lg font-medium text-gray-800 border-b pb-2">
            10. Relato vs Observação Inicial
          </h3>

          <div className="space-y-4 pt-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Dados Relatados pela Família
              </label>
              <textarea
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Observação Inicial do Fonoaudiólogo
              </label>
              <textarea
                {...register(
                  'languageDevelopment.reportVsObservation.professionalInitialObservation',
                )}
                rows={3}
                className="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
              />
            ...
            <div>
              ...
              <select
                {...register(
                  'languageDevelopment.reportVsObservation.needsComplementaryEvaluation',
                )}
