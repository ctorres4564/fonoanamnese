        ...
        <div className="space-y-6 pt-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Houve perda de habilidade linguística já adquirida?
            </label>
            <select
          ...
          {showRegressionFields && (
            <div className="bg-orange-50 border border-orange-200 p-4 rounded-md space-y-6">
              <div className="text-orange-800 text-sm font-medium mb-2">
                Foi relatada perda de habilidade linguística previamente adquirida. Essa informação
                requer investigação profissional e não constitui diagnóstico.
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Qual(is) habilidade(s) foi(ram) perdida(s)?
                </label>
                <input
                  type="text"
                ...
                {showOtherOnsetMode && (
                  <div className="md:col-span-2">
                    ...
                    <input
                      type="text"
                      {...register(
                        'languageDevelopment.languageRegression.otherOnsetModeDescription',
                      )}
                      className="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                    />
                  </div>
              ...
              <div className="space-y-4 border-t border-orange-200 pt-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {[
                    ...
                    {
                      key: 'professionalEvaluationPerformed',
                      label: 'Avaliação Profissional Realizada',
                    },
                  ].map((item) => (
                    <div key={item.key}>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
