...
describe('CommunicationDevelopmentSection', () => {
  ...
  it('exibe campos condicionais de regressão em palavras', () => {
    ...
    const wordLossSelect = container.querySelector(
      'select[name="communicationDevelopment.earlyLanguageDevelopment.wordLoss"]',
    ) as HTMLSelectElement
  ...
  it('exibe aviso de atenção clínica e campos condicionais na regressão geral', () => {
    ...
    const lossSelect = container.querySelector(
      'select[name="communicationDevelopment.communicationRegression.hadLoss"]',
    ) as HTMLSelectElement
  ...
  it('exibe campos para recurso de comunicação alternativa', () => {
    ...
    const resourceSelect = container.querySelector(
      'select[name="communicationDevelopment.alternativeCommunication.usesResource"]',
    ) as HTMLSelectElement
