    ...
    <FormProvider {...methods}>
      <div className="space-y-6">
        <div className="mb-4 text-sm text-gray-500">
          Esta seção avalia o desenvolvimento da fala, clareza, aspectos fonológicos, motores e o
          impacto funcional.
        </div>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm space-y-6">
          <h3 className="text-lg font-medium text-gray-800 border-b pb-2">
            3. Alterações de Fala Relatadas e Padrões
          </h3>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm space-y-6">
          <h3 className="text-lg font-medium text-gray-800 border-b pb-2">
            8. Histórico Familiar e Intervenções
          </h3>
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 shadow-sm space-y-6">
          <h4 className="font-semibold text-sm border-b pb-2 text-gray-800">
            Síntese e Encaminhamentos (Exclusivo do Avaliador)
          </h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center space-x-3">
              ...
              />
              <label
                htmlFor="needsPhonologicalEvaluation"
            ...
            <div className="flex items-center space-x-3">
              ...
              />
              <label
                htmlFor="needsArticulatoryEvaluation"
                className="text-sm font-medium text-gray-700"
              >
            ...
            <div className="flex items-center space-x-3">
              ...
              />
              <label
                htmlFor="needsMotorSpeechEvaluation"
                className="text-sm font-medium text-gray-700"
              >
