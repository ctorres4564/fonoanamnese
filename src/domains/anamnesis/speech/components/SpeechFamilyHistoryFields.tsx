  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-2">
        <input type="checkbox" id="familyHistory.notInformed" {...register('familyHistory.notInformed')} className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
      ...
      {!notInformed && (
        <div className="space-y-4">
          <div>
            ...
            <textarea {...register('familyHistory.description')} rows={3} className="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
          </div>
        </div>
      )}
    </div>
