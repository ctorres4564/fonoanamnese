export type SpeechDevelopmentEvolution = 'dentro_do_esperado' | 'tardio' | 'irregular' | 'houve_regressao' | 'nao_informado';
export type SpeechEvolutionStatus = 'melhorando' | 'estavel' | 'piorando' | 'oscilante' | 'nao_informado';
export type SpeechOnsetMode = 'gradual' | 'subito' | 'presente_desde_inicio' | 'nao_informado' | 'outro';
export type IntelligibilityLevel = 'totalmente_inteligivel' | 'predominantemente_inteligivel' | 'parcialmente_inteligivel' | 'pouco_inteligivel' | 'nao_inteligivel' | 'nao_observado' | 'nao_informado';
...
export type SoundClassStatus = 'aparentemente_adequada' | 'dificuldade_percebida' | 'variavel' | 'nao_observado' | 'nao_informado';
export type FrequencyScale = 'frequentemente' | 'as_vezes' | 'raramente' | 'nunca' | 'nao_observado' | 'nao_informado';
export type RateScale = 'adequada' | 'aumentada' | 'reduzida' | 'variavel' | 'nao_observada' | 'nao_informada';
export type RhythmScale = 'aparentemente_adequado' | 'irregular' | 'silabado' | 'acelerado' | 'reduzido' | 'nao_observado' | 'nao_informado';
export type PrecisionScale = 'adequada' | 'parcialmente_adequada' | 'reduzida' | 'variavel' | 'nao_observada' | 'nao_informada';
export type SpeechSampleType = 'conversa_espontanea' | 'nomeacao' | 'repeticao' | 'descricao_imagem' | 'leitura' | 'outra';
