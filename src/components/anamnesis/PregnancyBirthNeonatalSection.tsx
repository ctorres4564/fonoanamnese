...
import { pregnancyBirthNeonatalSchema } from '../../schemas/anamnesis';
import type { PregnancyBirthNeonatalSection as PregnancyBirthNeonatalSectionType } from '../../types/anamnesis';
...
export function PregnancyBirthNeonatalSection({ initialData, onChange }: PregnancyBirthNeonatalSectionProps) {
  ...
  return (
    <div className="space-y-12 max-w-5xl">
      <h2 className="text-xl font-semibold text-gray-800 border-b pb-2">Gestação, Parto e Período Neonatal</h2>
      <p className="text-sm text-gray-500 mt-2">
        Preencha os dados relacionados ao histórico gestacional, momento do parto e período após o nascimento.
      </p>
